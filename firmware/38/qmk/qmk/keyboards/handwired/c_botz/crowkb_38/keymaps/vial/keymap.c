    ...
    //                                    | -------+--------+--------|  |--------+--------+--------|
        ...
        [1] = LAYOUT(
    //         ,--------------------------------------------.                    ,-------------------------------------------.
                KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC,                      KC_MINS, KC_LCBR, KC_RCBR, KC_ASTR, KC_PLUS,
    //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
        KC_LGUI,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_UNDS, KC_LPRN, KC_RPRN, KC_QUOT, KC_DQT,  KC_TILD,
    //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
                    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,                       KC_EQL, KC_LBRC, KC_RBRC, KC_LABK, KC_RABK,
    //         |--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
                                                              _______,    _______,
    //                                    | -------+--------+--------|  |--------+--------+--------|
